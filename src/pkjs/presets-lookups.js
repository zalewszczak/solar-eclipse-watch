...
var FONT_LOOKUP = [
  ...
  { id: 5 , grid: true, label: 'Leco Small'            , height: 17, preview: 'font-family: Arial, sans-serif; font-weight: 300;'                                                       , small: false, google: null                   , sizePx: 28, sizeCategory: 'M', approx: true, categories: ['pebbleos', 'digital', 'thin', 'small']                    , sidesAllowed: '2' , sidesWithSeconds: '2' , mainClock: true  , romanOk: false , resourceName: "FONT_KEY_LECO_28_LIGHT_NUMBERS", fileName: null },              // Pebble's built-in rounded numerals font -- no Google Fonts equivalent; no substitute attempted beyond a plain sans, since Leco's own rounded-digit character is hard to approximate with a generic family.
  { id: 6 , grid: true, label: 'Leco Medium'           , height: 20, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: false, google: null                   , sizePx: 32, sizeCategory: 'M', approx: true, categories: ['pebbleos', 'digital', 'bold', 'small']                    , sidesAllowed: 2   , sidesWithSeconds: '2' , mainClock: true  , romanOk: false , resourceName: "FONT_KEY_LECO_32_BOLD_NUMBERS", fileName: null },              // see id 5
  { id: 7 , grid: true, label: 'Leco Large'            , height: 23, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: false, google: null                   , sizePx: 36, sizeCategory: 'L', approx: true, categories: ['pebbleos', 'digital', 'bold', 'medium']                   , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true  , romanOk: false , resourceName: "FONT_KEY_LECO_36_BOLD_NUMBERS", fileName: null },              // see id 5
  { id: 8 , grid: true, label: 'Leco XL'               , height: 26, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: false, google: null                   , sizePx: 42, sizeCategory: 'L', approx: true, categories: ['pebbleos', 'digital', 'bold', 'medium']                   , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true  , romanOk: false , resourceName: "FONT_KEY_LECO_42_NUMBERS", fileName: null },              // see id 5
  ...
  { id: 18, grid: true, label: 'Minecrafter Small'     , height: 12, preview: 'font-family: \'Fizzy Soda\', \'Courier New\', monospace;'                                                , small: true , sizePx: 12, sizeCategory: 'XS', approx: true, categories: ['pixelated', 'funky', 'tiny']                              , sidesAllowed: null, sidesWithSeconds: null, cdn: 'fizzy-soda'    , romanOk: true , resourceName: "MINECRAFTER_FONT_12", fileName: "fonts/Minecrafter.ttf" },                                           // Minecrafter (dafont-only) itself isn't on cdnfonts, but Fizzy Soda (also on cdnfonts) is an almost identical blocky pixel-game face -- much closer than Google Fonts' own Press Start 2P was.
  { id: 19, grid: false, label: 'Minecrafter'           , height: 40, preview: 'font-family: \'Fizzy Soda\', \'Courier New\', monospace;'                                                , small: false, sizePx: 48, sizeCategory: 'L', approx: true, categories: ['pixelated', 'funky', 'wide', 'large']                     , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , cdn: 'fizzy-soda'    , romanOk: false , resourceName: "MINECRAFTER_FONT_48", fileName: "fonts/Minecrafter.ttf" },                         // see id 18
  { id: 20, grid: true, label: 'SF Pixelate'           , height: 40, preview: 'font-family: \'DotGothic16\', \'Courier New\', monospace;'                                               , small: false, google: 'DotGothic16'          , sizePx: 48, sizeCategory: 'L', approx: true, categories: ['pixelated', 'digital', 'wide', 'large']                   , sidesAllowed: '1' , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: false , resourceName: "SFPIXELATE_FONT_48", fileName: "fonts/SFPixelate.ttf" }, // see id 20
  { id: 21, grid: true, label: 'Alagard Small'         , height: 19, preview: 'font-family: \'Pixelify Sans\', \'Century Gothic\', sans-serif; font-weight: 600;'                       , small: true , google: 'Pixelify Sans'        , sizePx: 19, sizeCategory: 'S', approx: true, categories: ['pixelated', 'stylish', 'small']                           , sidesAllowed: null, sidesWithSeconds: null, weight: 600 , romanOk: true , resourceName: "ALAGARD_FONT_19", fileName: "fonts/alagard.ttf" },                   // Alagard (dafont-only, Hewett Tsoi's 16px fantasy bitmap face) isn't on Google Fonts -- Pixelify Sans's blocky pixel-game look is the closest available match.
  { id: 22, grid: true, label: 'Alagard'               , height: 40, preview: 'font-family: \'Pixelify Sans\', \'Century Gothic\', sans-serif; font-weight: 600;'                       , small: false, google: 'Pixelify Sans'        , sizePx: 48, sizeCategory: 'L', categories: ['pixelated', 'stylish', 'large', 'funky']                  , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true , weight: 600 , romanOk: false , resourceName: "ALAGARD_FONT_48", fileName: "fonts/alagard.ttf" },               // see id 22
  ...
  { id: 38, grid: true, label: 'StackSansHeadline'     , height: 40, preview: 'font-family: \'Stack Sans Headline\', \'Arial Narrow\', sans-serif;'                                     , small: false, google: 'Stack Sans Headline'  , sizePx: 48, sizeCategory: 'L', approx: true, categories: ['modern', 'narrow', 'large', 'thin', 'stylish']            , sidesAllowed: '1' , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: false , resourceName: "STACKSANSHEADLINE_FONT_48", fileName: "fonts/StackSansHeadline.ttf" },
  ...
  { id: 54, grid: true, label: 'LCD'                   , height: 48, preview: 'font-family: \'Press Start 2P\', \'Courier New\', monospace;'                                            , small: false, google: 'Press Start 2P'       , sizePx: 48, sizeCategory: 'L', approx: true, categories: ['digital', 'pixelated', 'large', 'bold']                   , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: true , resourceName: "LCDSOLID_FONT_48", fileName: "fonts/LCD_Solid.ttf" }, // see id 50
  ...
  { id: 57, grid: true, label: 'SciFly Sans'       , height: 54, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: false, cdn: 'scifly', sizePx: 54, sizeCategory: 'L', approx: true, categories: ['stylish', 'modern', 'digital', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '-1' , mainClock: true , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
  { id: 58, grid: true, label: 'SciFly Sans small'       , height: 21, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: true, cdn: 'scifly', sizePx: 21, sizeCategory: 'S', approx: true, categories: ['stylish', 'modern', 'digital', 'small']                      , mainClock: false , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
  { id: 59, grid: true, label: 'Bitcount Grid'       , height: 48, preview: 'font-family: \'Bitcount Grid Double\', \'Courier New\', monospace;'                              , small: false, google: 'Bitcount Grid Double', sizePx: 48, sizeCategory: 'L', approx: true, categories: ['digital', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 300 , romanOk: true, resourceName: "BITCOUNTGRID_FONT_48", fileName: "fonts/BitcountGridDouble-Light.ttf" },
  ...
  { id: 100, grid: false, label: 'Amatic SC', height: 150, preview: 'font-family: Amatic SC, Arial, sans-serif; font-weight: 400;', small: false, sizePx: 150, sizeCategory: 'XL', approx: true, categories: ['bigDigital'], bigDigital: true, sidesAllowed: null, sidesWithSeconds: null, mainClock: false, weight: 400, cdn: 'amatic-sc-3' , romanOk: false, resourceName: null, fileName: null },
  { id: 101, grid: false, label: 'Dorsa', height: 150, preview: 'font-family: Dorsa, Arial, sans-serif; font-weight: 400;', small: false, google: 'Dorsa' , sizePx: 150, sizeCategory: 'XL', approx: true, categories: ['bigDigital'], bigDigital: true, sidesAllowed: null, sidesWithSeconds: null, weight: 400, mainClock: false, romanOk: false, resourceName: null, fileName: null },
  { id: 102, grid: false, label: 'Imbue Light', height: 150, preview: 'font-family: Imbue, Arial, sans-serif; font-weight: 300;', small: false, sizePx: 150, sizeCategory: 'XL', approx: true, categories: ['bigDigital'], bigDigital: true, sidesAllowed: null, sidesWithSeconds: null, mainClock: false, weight: 300, cdn: 'imbue', romanOk: false, resourceName: null, fileName: null },
  { id: 103, grid: false, label: 'PP Right Gothic', height: 150, preview: 'font-family: PP Right Gothic, Arial, sans-serif; font-weight: 400;', small: false, sizePx: 150, sizeCategory: 'XL', approx: true, categories: ['bigDigital'], bigDigital: true, sidesAllowed: null, sidesWithSeconds: null, weight: 400, cdn: 'pp-right-gothic', mainClock: false, romanOk: false, resourceName: null, fileName: null },
  { id: 104, grid: false, label: 'Wire One', height: 150, preview: 'font-family: Wire One, Arial, sans-serif; font-weight: 400;', small: false, google: 'Wire One', sizePx: 150, sizeCategory: 'XL', approx: true, categories: ['bigDigital'], bigDigital: true, sidesAllowed: null, sidesWithSeconds: null, weight: 400, mainClock: false, romanOk: false, resourceName: null, fileName: null },
