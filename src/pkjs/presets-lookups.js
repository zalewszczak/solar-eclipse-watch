...
var FONT_LOOKUP = [
  ...
  { id: 57, label: 'SciFly Sans'       , height: 48, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: false, cdn: 'scifly', sizePx: 48, approx: true, categories: ['stylish', 'digital', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
  { id: 58, label: 'SciFly Sans small'       , height: 21, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: true, cdn: 'scifly', sizePx: 21, approx: true, categories: ['stylish', 'digital', 'small']                      , mainClock: false , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
