...
var FONT_LOOKUP = [
  { id: 0 , label: 'Gothic X-Small'        , height: 14, preview: 'font-family: Arial, sans-serif;'                                                                         , small: true , google: null                   , sizePx: 14, approx: true, categories: ['pebbleos', 'modern', 'tiny']                              , sidesAllowed: null, sidesWithSeconds: null , romanOk: true },                                // Pebble's built-in "Gothic" system font -- no Google Fonts equivalent by name; Arial/Helvetica is the closest common grotesque.
  { id: 1 , label: 'Gothic Small'          , height: 18, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: true , google: null                   , sizePx: 14, approx: true, categories: ['pebbleos', 'modern', 'bold', 'small']                     , sidesAllowed: null, sidesWithSeconds: null , romanOk: true },                                // see id 0
  { id: 2 , label: 'Gothic Medium'         , height: 24, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: true , google: null                   , sizePx: 17, approx: true, categories: ['pebbleos', 'modern', 'bold', 'medium']                    , sidesAllowed: null, sidesWithSeconds: null , romanOk: true },                                // see id 0
  { id: 3 , label: 'Gothic Large'          , height: 32, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: true , google: null                   , sizePx: 24, approx: true, categories: ['pebbleos', 'modern', 'bold', 'large']                     , sidesAllowed: null, sidesWithSeconds: null , romanOk: true },                                // see id 0
  { id: 4 , label: 'Gothic X-Large'        , height: 36, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: true , google: null                   , sizePx: 28, approx: true, categories: ['pebbleos', 'modern', 'bold', 'large']                     , sidesAllowed: null, sidesWithSeconds: null , romanOk: true },                                // see id 0
  { id: 5 , label: 'Leco Small'            , height: 17, preview: 'font-family: Arial, sans-serif; font-weight: 300;'                                                       , small: false, google: null                   , sizePx: 28, approx: true, categories: ['pebbleos', 'digital', 'thin', 'small']                    , sidesAllowed: '2' , sidesWithSeconds: '2' , mainClock: true  , romanOk: false },              // Pebble's built-in rounded numerals font -- no Google Fonts equivalent; no substitute attempted beyond a plain sans, since Leco's own rounded-digit character is hard to approximate with a generic family.
  { id: 6 , label: 'Leco Medium'           , height: 20, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: false, google: null                   , sizePx: 32, approx: true, categories: ['pebbleos', 'digital', 'bold', 'small']                    , sidesAllowed: 2   , sidesWithSeconds: '2' , mainClock: true  , romanOk: false },              // see id 5
  { id: 7 , label: 'Leco Large'            , height: 23, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: false, google: null                   , sizePx: 36, approx: true, categories: ['pebbleos', 'digital', 'bold', 'medium']                   , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true  , romanOk: false },              // see id 5
  { id: 8 , label: 'Leco XL'               , height: 26, preview: 'font-family: Arial, sans-serif; font-weight: 700;'                                                       , small: false, google: null                   , sizePx: 42, approx: true, categories: ['pebbleos', 'digital', 'bold', 'medium']                   , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true  , romanOk: false },              // see id 5
  { id: 9 , label: 'Droid Serif'           , height: 17, preview: 'font-family: \'Droid Serif\', Georgia, serif; font-weight: 700;'                                         , small: true , google: 'Droid Serif'          , sizePx: 28, categories: ['pebbleos', 'serif', 'bold', 'small']                      , sidesAllowed: null, sidesWithSeconds: null, weight: 700 , romanOk: true },                                 // still genuinely on Google Fonts (legacy listing, but live)
  { id: 10, label: 'Roboto Condensed'      , height: 15, preview: 'font-family: \'Roboto Condensed\', Arial, sans-serif;'                                                   , small: true , google: 'Roboto Condensed'     , sizePx: 21, categories: ['pebbleos', 'modern', 'narrow', 'small']                   , sidesAllowed: null, sidesWithSeconds: null, weight: 400 , romanOk: true },
  { id: 11, label: 'Roboto Bold'           , height: 30, preview: 'font-family: \'Roboto\', Arial, sans-serif; font-weight: 700;'                                           , small: false, google: 'Roboto'               , sizePx: 49, categories: ['pebbleos', 'modern', 'bold', 'medium']                    , sidesAllowed: '1' , sidesWithSeconds: '0' , mainClock: true , weight: 700 , romanOk: false },
  { id: 12, label: 'Bitham Bold 30'        , height: 19, preview: 'font-family: \'Futura\', \'Century Gothic\', sans-serif; font-weight: 700;'                              , small: false, google: null                   , sizePx: 30, approx: true, categories: ['pebbleos', 'modern', 'bold', 'small']                     , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true  , romanOk: true },              // Pebble's built-in Bitham -- no Google Fonts equivalent; Futura/Century Gothic (neither actually Google Fonts either) are the closest geometric-sans stand-ins available without downloading anything.
  { id: 13, label: 'Bitham Medium 34'      , height: 21, preview: 'font-family: \'Futura\', \'Century Gothic\', sans-serif; font-weight: 500;'                              , small: false, google: null                   , sizePx: 34, approx: true, categories: ['pebbleos', 'modern', 'medium']                            , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true  , romanOk: false },              // see id 12
  { id: 14, label: 'Bitham Light'          , height: 26, preview: 'font-family: \'Futura\', \'Century Gothic\', sans-serif; font-weight: 300; letter-spacing: 1px;'         , small: false, google: null                   , sizePx: 42, approx: true, categories: ['pebbleos', 'modern', 'thin', 'medium']                    , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true  , romanOk: true },              // see id 12
  { id: 15, label: 'Bitham Bold'           , height: 26, preview: 'font-family: \'Futura\', \'Century Gothic\', sans-serif; font-weight: 700; letter-spacing: 1px;'         , small: false, google: null                   , sizePx: 42, approx: true, categories: ['pebbleos', 'modern', 'bold', 'medium']                    , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true  , romanOk: true },              // see id 12
  { id: 16, label: 'Digital Dream Small'   , height: 12, preview: 'font-family: \'Digital dream\', \'Courier New\', monospace; letter-spacing: 1px;'                        , small: true , sizePx: 12, categories: ['digital', 'narrow', 'tiny']                               , sidesAllowed: null, sidesWithSeconds: null, cdn: 'digital-dream' , romanOk: true },                                                         // Digital Dream (Pizzadude, dafont-only) isn't on Google Fonts, but the exact same font is hosted on cdnfonts.com as a webfont -- see cdnFontLinks() in config-page.js for how the extra <link> gets added.
  { id: 17, label: 'Digital Dream'         , height: 40, preview: 'font-family: \'Digital dream\', \'Courier New\', monospace; letter-spacing: 2px; font-style: italic;'    , small: false, sizePx: 48, categories: ['digital', 'large', 'wide', 'thin', 'italic']              , sidesAllowed: '0' , sidesWithSeconds: '-1', mainClock: true , cdn: 'digital-dream', italic: true , romanOk: false },                         // see id 16
  { id: 18, label: 'Minecrafter Small'     , height: 12, preview: 'font-family: \'Fizzy Soda\', \'Courier New\', monospace;'                                                , small: true , sizePx: 12, approx: true, categories: ['pixelated', 'funky', 'tiny']                              , sidesAllowed: null, sidesWithSeconds: null, cdn: 'fizzy-soda'    , romanOk: true },                                           // Minecrafter (dafont-only) itself isn't on cdnfonts, but Fizzy Soda (also on cdnfonts) is an almost identical blocky pixel-game face -- much closer than Google Fonts' own Press Start 2P was.
  { id: 19, label: 'Minecrafter'           , height: 40, preview: 'font-family: \'Fizzy Soda\', \'Courier New\', monospace;'                                                , small: false, sizePx: 48, approx: true, categories: ['pixelated', 'funky', 'wide', 'large']                     , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , cdn: 'fizzy-soda'    , romanOk: false },                         // see id 18
  { id: 20, label: 'SF Pixelate'           , height: 40, preview: 'font-family: \'DotGothic16\', \'Courier New\', monospace;'                                               , small: false, google: 'DotGothic16'          , sizePx: 48, approx: true, categories: ['pixelated', 'digital', 'wide', 'large']                   , sidesAllowed: '1' , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: false }, // see id 20
  { id: 21, label: 'Alagard Small'         , height: 19, preview: 'font-family: \'Pixelify Sans\', \'Century Gothic\', sans-serif; font-weight: 600;'                       , small: true , google: 'Pixelify Sans'        , sizePx: 19, approx: true, categories: ['pixelated', 'stylish', 'small']                           , sidesAllowed: null, sidesWithSeconds: null, weight: 600 , romanOk: true },                   // Alagard (dafont-only, Hewett Tsoi's 16px fantasy bitmap face) isn't on Google Fonts -- Pixelify Sans's blocky pixel-game look is the closest available match.
  { id: 22, label: 'Alagard'               , height: 40, preview: 'font-family: \'Pixelify Sans\', \'Century Gothic\', sans-serif; font-weight: 600;'                       , small: false, google: 'Pixelify Sans'        , sizePx: 48, categories: ['pixelated', 'stylish', 'large', 'funky']                  , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true , weight: 600 , romanOk: false },               // see id 22
  { id: 23, label: 'Bebas Small'           , height: 20, preview: 'font-family: \'Bebas Neue\', \'Century Gothic\', sans-serif; letter-spacing: 1px;'                       , small: true , google: 'Bebas Neue'           , sizePx: 20, categories: ['stylish', 'modern', 'narrow', 'small']                    , sidesAllowed: null, sidesWithSeconds: null, weight: 400 , romanOk: true },
  { id: 24, label: 'Bebas'                 , height: 40, preview: 'font-family: \'Bebas Neue\', \'Century Gothic\', sans-serif; letter-spacing: 1px;'                       , small: false, google: 'Bebas Neue'           , sizePx: 48, categories: ['stylish', 'modern', 'narrow', 'large']                    , sidesAllowed: 2   , sidesWithSeconds: '1' , mainClock: true , weight: 400 , romanOk: false },
  { id: 25, label: 'Amita'                 , height: 40, preview: 'font-family: \'Amita\', Impact, sans-serif; font-weight: 700;'                                           , small: false, google: 'Amita'                , sizePx: 48, categories: ['stylish', 'handwritten', 'large', 'thin', 'wide', 'serif'], sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 700 , romanOk: false },
  { id: 26, label: 'Averia'                , height: 40, preview: 'font-family: \'Averia Serif Libre\', \'Courier New\', serif; font-weight: 700; font-style: italic;'      , small: false, google: 'Averia Serif Libre'   , sizePx: 48, categories: ['serif', 'italic', 'bold', 'wide', 'large']                , sidesAllowed: '2' , sidesWithSeconds: '0' , mainClock: true , weight: 700, italic: true , romanOk: false },
  { id: 27, label: 'Bagel'                 , height: 40, preview: 'font-family: \'Bagel Fat One\', \'Courier New\', monospace;'                                             , small: false, google: 'Bagel Fat One'        , sizePx: 48, categories: ['funky', 'bold', 'wide', 'large']                          , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 28, label: 'Bricolage Grotesque'   , height: 40, preview: 'font-family: \'Bricolage Grotesque\', Impact, \'Arial Narrow\', sans-serif; font-weight: 700;'           , small: false, google: 'Bricolage Grotesque'  , sizePx: 48, categories: ['modern', 'bold', 'wide', 'large']                         , sidesAllowed: '2' , sidesWithSeconds: '0' , mainClock: true , weight: 700 , romanOk: false },
  { id: 29, label: 'Chango'                , height: 40, preview: 'font-family: \'Chango\', \'Courier New\', monospace;'                                                    , small: false, google: 'Chango'               , sizePx: 48, categories: ['funky', 'stylish', 'bold', 'large', 'wide']               , sidesAllowed: '0' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 30, label: 'EmblemaOne'            , height: 40, preview: 'font-family: \'Emblema One\', \'Arial Narrow\', sans-serif; letter-spacing: 1px;'                        , small: false, google: 'Emblema One'          , sizePx: 48, categories: ['stylish', 'bold', 'large', 'wide', 'italic']              , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 31, label: 'Fraunces'              , height: 40, preview: 'font-family: \'Fraunces\', Georgia, serif; font-weight: 700;'                                            , small: false, google: 'Fraunces'             , sizePx: 48, categories: ['serif', 'stylish', 'bold', 'large', 'funky']              , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 700 , romanOk: false },
  { id: 32, label: 'Geostar Fill'          , height: 40, preview: 'font-family: \'Geostar Fill\', Impact, sans-serif;'                                                      , small: false, google: 'Geostar Fill'         , sizePx: 48, categories: ['stylish', 'funky', 'modern', 'large', 'thin', 'wide']     , sidesAllowed: '0' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 33, label: 'Michroma'              , height: 40, preview: 'font-family: \'Michroma\', \'Arial Black\', sans-serif; letter-spacing: 1px;'                            , small: false, google: 'Michroma'             , sizePx: 48, categories: ['modern', 'wide', 'large', 'thin', 'stylish']              , sidesAllowed: '0' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 34, label: 'National Park'         , height: 40, preview: 'font-family: \'National Park\', Verdana, sans-serif; font-weight: 700;'                                  , small: false, google: 'National Park'        , sizePx: 48, categories: ['modern', 'stylish', 'bold', 'large']                      , sidesAllowed: '1' , sidesWithSeconds: '0' , mainClock: true , weight: 700 , romanOk: false },
  { id: 35, label: 'Komika'                , height: 40, preview: 'font-family: \'Bangers\', \'Comic Sans MS\', cursive;'                                                   , small: false, google: 'Bangers'              , sizePx: 48, approx: true, categories: ['funky', 'bold', 'wide', 'large', 'handwritten', 'italic'] , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false }, // Komika Hand (Apostrophic Labs, dafont-only) isn't on Google Fonts -- Bangers is the closest bold comic-lettering face Google Fonts actually has.
  { id: 36, label: 'Quantico'              , height: 40, preview: 'font-family: \'Quantico\', Impact, \'Arial Narrow\', sans-serif; font-weight: 700; font-style: italic;'  , small: false, google: 'Quantico'             , sizePx: 48, categories: ['modern', 'italic', 'bold', 'large', 'stylish']            , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 700, italic: true , romanOk: false },
  { id: 37, label: 'Silkscreen'            , height: 40, preview: 'font-family: \'Silkscreen\', Impact, \'Arial Narrow\', sans-serif;'                                      , small: false, google: 'Silkscreen'           , sizePx: 48, categories: ['pixelated', 'digital', 'large']                           , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 38, label: 'StackSansHeadline'     , height: 40, preview: 'font-family: \'Anton\', \'Arial Narrow\', sans-serif;'                                                   , small: false, google: 'Anton'                , sizePx: 48, approx: true, categories: ['modern', 'narrow', 'large', 'thin', 'stylish']            , sidesAllowed: '1' , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: false }, // Stack Sans Headline isn't on Google Fonts (independent foundry release) -- Anton's ultra-bold condensed headline shape is the closest match.
  { id: 39, label: 'Unbounded'             , height: 40, preview: 'font-family: \'Unbounded\', Impact, \'Arial Narrow\', sans-serif; font-weight: 500;'                     , small: false, google: 'Unbounded'            , sizePx: 48, categories: ['modern', 'stylish', 'bold', 'large', 'wide']              , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 500 , romanOk: false },
  { id: 40, label: 'Wallpoet'              , height: 40, preview: 'font-family: \'Wallpoet\', Impact, \'Arial Narrow\', sans-serif;'                                        , small: false, google: 'Wallpoet'             , sizePx: 48, categories: ['stylish', 'funky', 'modern', 'large', 'bold', 'wide']     , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: false },
  { id: 41, label: 'ZalandoSans'           , height: 40, preview: 'font-family: \'Zalando Sans Expanded\', Impact, \'Arial Narrow\', sans-serif; font-weight: 500;'         , small: false, google: 'Zalando Sans Expanded', sizePx: 48, categories: ['modern', 'wide', 'bold', 'large', 'stylish']              , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 500 , romanOk: false },
  { id: 42, label: 'Bytesized'             , height: 16, preview: 'font-family: \'Bytesized\', Impact, \'Arial Narrow\', sans-serif; font-weight: 400;'                     , small: true , google: 'Bytesized'            , sizePx: 16, categories: ['pixelated', 'small']                                      , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, weight: 400 , romanOk: true },
  { id: 43, label: 'M Plus 1C'             , height: 16, preview: 'font-family: \'M PLUS 1 Code\', Impact, \'Arial Narrow\', sans-serif; font-weight: 700;'                 , small: true , google: 'M PLUS 1 Code'        , sizePx: 16, categories: ['modern', 'bold', 'small']                                 , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, weight: 700 , romanOk: true },
  { id: 44, label: 'Noto Serif'            , height: 18, preview: 'font-family: \'Noto Serif\', Impact, \'Arial Narrow\', sans-serif; font-weight: 500; font-style: italic;', small: true , google: 'Noto Serif'           , sizePx: 18, categories: ['serif', 'italic', 'small']                                , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, weight: 500, italic: true , romanOk: true },
  { id: 45, label: 'M Plus 1C'             , height: 40, preview: 'font-family: \'M PLUS 1 Code\', Impact, \'Arial Narrow\', sans-serif; font-weight: 700;'                 , small: false, google: 'M PLUS 1 Code'        , sizePx: 48, categories: ['modern', 'bold', 'large', 'wide']                         , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 700 , romanOk: false },
  { id: 46, label: 'Reddit Sans'           , height: 40, preview: 'font-family: \'Reddit Sans\', Impact, \'Arial Narrow\', sans-serif; font-weight: 700;'                   , small: false, google: 'Reddit Sans'          , sizePx: 48, categories: ['modern', 'bold', 'large']                                 , sidesAllowed: '2' , sidesWithSeconds: '-1', mainClock: true , weight: 700 , romanOk: false },
  { id: 47, label: 'Arcade'                , height: 18, preview: 'font-family: \'ArcadeClassic\', \'Courier New\', monospace;'                                             , small: true , sizePx: 18, categories: ['digital', 'pixelated', 'small']                           , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, cdn: 'arcadeclassic' , romanOk: true },                                       // ArcadeClassic (Pizzadude, dafont-only) is hosted on cdnfonts.com as a webfont under its own name -- see cdnFontLinks() below.
  { id: 48, label: 'DS Digital Bold'       , height: 20, preview: 'font-family: \'DS-Digital\', \'Courier New\', monospace; font-weight: 700;'                              , small: true , sizePx: 20, categories: ['digital', 'bold', 'small']                                , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, cdn: 'ds-digital'    , romanOk: true },                                       // DS-Digital is hosted on cdnfonts.com as a webfont -- see cdnFontLinks() below.
  { id: 49, label: 'DS Digital Bold Italic', height: 20, preview: 'font-family: \'DS-Digital\', \'Courier New\', monospace; font-weight: 700; font-style: italic;'          , small: true , sizePx: 20, categories: ['digital', 'bold', 'italic', 'small']                      , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, cdn: 'ds-digital'    , romanOk: true },                                       // see id 48
  { id: 50, label: 'LCD'                   , height: 18, preview: 'font-family: \'Press Start 2P\', \'Courier New\', monospace;'                                            , small: true , google: 'Press Start 2P'       , sizePx: 18, approx: true, categories: ['digital', 'pixelated', 'small']                           , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, weight: 400 , romanOk: true }, // LCD Solid (dafont-only) doesn't appear to be hosted on cdnfonts.com or Google Fonts under its own name -- Press Start 2P remains the closest available blocky-digital match found so far.
  { id: 51, label: 'Radioland'             , height: 16, preview: 'font-family: \'Radioland\', \'Courier New\', monospace;'                                                 , small: true , sizePx: 16, categories: ['digital', 'small']                                        , sidesAllowed: null, sidesWithSeconds: null, mainClock: false, cdn: 'radioland'     , romanOk: true },                                       // Radioland (Pizzadude, dafont-only) is hosted on cdnfonts.com as a webfont under its own name -- see cdnFontLinks() below.
  { id: 52, label: 'DS Digital Bold'       , height: 48, preview: 'font-family: \'DS-Digital\', \'Courier New\', monospace; font-weight: 700;'                              , small: false, sizePx: 48, categories: ['digital', 'bold', 'large', 'italic']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , cdn: 'ds-digital'    , romanOk: true },                                       // see id 48
  { id: 53, label: 'DS Digital Bold Italic', height: 48, preview: 'font-family: \'DS-Digital\', \'Courier New\', monospace; font-weight: 700; font-style: italic;'          , small: false, sizePx: 48, categories: ['digital', 'bold', 'italic', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , cdn: 'ds-digital'    , romanOk: true },                                       // see id 48
  { id: 54, label: 'LCD'                   , height: 48, preview: 'font-family: \'Press Start 2P\', \'Courier New\', monospace;'                                            , small: false, google: 'Press Start 2P'       , sizePx: 48, approx: true, categories: ['digital', 'pixelated', 'large', 'bold']                   , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , weight: 400 , romanOk: true }, // see id 50
  { id: 55, label: 'Rebel Redux'           , height: 48, preview: 'font-family: \'RebelRedux\', \'Arial Narrow\', \'Impact\', sans-serif; font-weight: 500;'                , small: false, sizePx: 48, categories: ['stylish', 'funky', 'modern', 'large', 'thin', 'wide']     , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , cdn: 'rebelredux'    , romanOk: true },                                       // RebelRedux (dafont-only) is hosted on cdnfonts.com as a webfont -- see cdnFontLinks() in config-page.js. (Pizzadude, dafont-only) is hosted on cdnfonts.com as a webfont under its own name -- see cdnFontLinks() below.
  { id: 56, label: '00TT'       , height: 48, preview: 'font-family: \'Press Start 2P\', \'Courier New\', monospace;'                              , small: false, google: 'Press Start 2P', sizePx: 48, approx: true, categories: ['digital', 'bold', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: true },                                       // see id 48
