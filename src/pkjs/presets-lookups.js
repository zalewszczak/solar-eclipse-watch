...
{ id: 0 , grid: true, label: 'Gothic X-Small'        , height: 14, preview: 'font-family: Arial, sans-serif;'                                                                         , small: true , google: null                   , sizePx: 14, sizeCategory: 'XS', approx: true, categories: ['pebbleos', 'modern', 'tiny']                              , sidesAllowed: null, sidesWithSeconds: null , romanOk: true , resourceName: "FONT_KEY_GOTHIC_14", fileName: null },                                // Pebble's built-in "Gothic" system font -- no Google Fonts equivalent by name; Arial/Helvetica is the closest common grotesque.
  ...
  { id: 23, grid: true, label: 'Bebas Small'           , height: 20, preview: 'font-family: \'Bebas Neue\', \'Century Gothic\', sans-serif; letter-spacing: 1px;'                       , small: true , google: 'Bebas Neue'           , sizePx: 20, sizeCategory: 'S', categories: ['stylish', 'modern', 'narrow', 'small']                    , sidesAllowed: null, sidesWithSeconds: null, weight: 400 , romanOk: true , resourceName: "BEBAS_FONT_20", fileName: "fonts/BebasNeueBold.otf" },
...
{ id: 55, grid: true, label: 'Rebel Redux'           , height: 48, preview: 'font-family: \'RebelRedux\', \'Arial Narrow\', \'Impact\', sans-serif; font-weight: 500;'                , small: false, sizePx: 48, sizeCategory: 'L', categories: ['stylish', 'funky', 'modern', 'large', 'thin', 'wide']     , sidesAllowed: '1' , sidesWithSeconds: '-1', mainClock: true , cdn: 'rebelredux'    , romanOk: true , resourceName: "REBELREDUX_FONT_48", fileName: "fonts/RebelRedux.ttf" },                                       // RebelRedux (dafont-only) is hosted on cdnfonts.com as a webfont -- see cdnFontLinks() in config-page.js. (Pizzadude, dafont-only) is hosted on cdnfonts.com as a webfont under its own name -- see cdnFontLinks() below.
  ...
  { id: 58, grid: true, label: 'SciFly Sans small'       , height: 21, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: true, cdn: 'scifly', sizePx: 21, sizeCategory: 'S', categories: ['stylish', 'modern', 'digital', 'small']                      , mainClock: false , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
