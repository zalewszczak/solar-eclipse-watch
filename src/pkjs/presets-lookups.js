...
var FONT_LOOKUP = [
  ...
  { id: 5,  label: 'Leco Small',          height: 17, preview: "font-family: Arial, sans-serif; font-weight: 300;", small: false, mainClock: true, google: null, sizePx: 17, approx: true, categories: ['pebbleos', 'digital', 'thin', 'small'], sidesAllowed: 2, sidesWithSeconds: 1 }, // Pebble's built-in rounded numerals font -- no Google Fonts equivalent; no substitute attempted beyond a plain sans, since Leco's own rounded-digit character is hard to approximate with a generic family.
  { id: 6,  label: 'Leco Medium',         height: 20, preview: "font-family: Arial, sans-serif; font-weight: 700;", small: false, mainClock: true, google: null, sizePx: 20, approx: true, categories: ['pebbleos', 'digital', 'bold', 'small'], sidesAllowed: 2, sidesWithSeconds: 1 }, // see id 5
  { id: 7,  label: 'Leco Large',          height: 23, preview: "font-family: Arial, sans-serif; font-weight: 700;", small: false, mainClock: true, google: null, sizePx: 23, approx: true, categories: ['pebbleos', 'digital', 'bold', 'medium'], sidesAllowed: 2, sidesWithSeconds: 1 }, // see id 5
  { id: 8,  label: 'Leco XL',             height: 26, preview: "font-family: Arial, sans-serif; font-weight: 700;", small: false, mainClock: true, google: null, sizePx: 26, approx: true, categories: ['pebbleos', 'digital', 'bold', 'medium'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 5
  ...
  { id: 11, label: 'Roboto Bold',         height: 30, preview: "font-family: 'Roboto', Arial, sans-serif; font-weight: 700;", small: false, mainClock: true, google: 'Roboto', weight: 700, sizePx: 30, categories: ['pebbleos', 'modern', 'bold', 'medium'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 12, label: 'Bitham Bold 30',      height: 19, preview: "font-family: 'Futura', 'Century Gothic', sans-serif; font-weight: 700;", small: false, mainClock: true, google: null, sizePx: 19, approx: true, categories: ['pebbleos', 'modern', 'bold', 'small'], sidesAllowed: 2, sidesWithSeconds: 0 }, // Pebble's built-in Bitham -- no Google Fonts equivalent; Futura/Century Gothic (neither actually Google Fonts either) are the closest geometric-sans stand-ins available without downloading anything.
  { id: 13, label: 'Bitham Medium 34',    height: 21, preview: "font-family: 'Futura', 'Century Gothic', sans-serif; font-weight: 500;", small: false, mainClock: true, google: null, sizePx: 21, approx: true, categories: ['pebbleos', 'modern', 'medium'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 12
  { id: 14, label: 'Bitham Light',        height: 26, preview: "font-family: 'Futura', 'Century Gothic', sans-serif; font-weight: 300; letter-spacing: 1px;", small: false, mainClock: true, google: null, sizePx: 26, approx: true, categories: ['pebbleos', 'modern', 'thin', 'medium'], sidesAllowed: 2, sidesWithSeconds: 1 }, // see id 12
  { id: 15, label: 'Bitham Bold',         height: 26, preview: "font-family: 'Futura', 'Century Gothic', sans-serif; font-weight: 700; letter-spacing: 1px;", small: true, mainClock: true, google: null, sizePx: 26, approx: true, categories: ['pebbleos', 'modern', 'bold', 'medium'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 12
  ...
  { id: 17, label: 'Digital Dream',       height: 40, preview: "font-family: 'Digital dream', 'Courier New', monospace; letter-spacing: 2px;", small: false, mainClock: true, cdn: 'digital-dream', sizePx: 48, categories: ['digital', 'narrow', 'large'], sidesAllowed: 1, sidesWithSeconds: 0 }, // see id 16
  ...
  { id: 20, label: 'SF Pixelate',         height: 40, preview: "font-family: 'DotGothic16', 'Courier New', monospace;", small: false, mainClock: true,
  ...
  { id: 22, label: 'Alagard',             height: 40, preview: "font-family: 'Pixelify Sans', 'Century Gothic', sans-serif; font-weight: 600;", small: false, mainClock: true, google: 'Pixelify Sans', weight: 600, sizePx: 48, categories: ['pixelated', 'stylish', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 22
  ...
  { id: 25, label: 'Amita',               height: 40, preview: "font-family: 'Amita', Impact, sans-serif; font-weight: 700;", small: false, mainClock: true, google: 'Amita', weight: 700, sizePx: 48, categories: ['stylish', 'handwritten', 'bold', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 26, label: 'AveriaSerifLibre',    height: 40, preview: "font-family: 'Averia Serif Libre', 'Courier New', serif; font-weight: 700; font-style: italic;", small: false, mainClock: true,
  ...
  { id: 27, label: 'Bagel',               height: 40, preview: "font-family: 'Bagel Fat One', 'Courier New', monospace;", small: false, mainClock: true,
    google: 'Bagel Fat One', weight: 400, sizePx: 48, categories: ['funky', 'bold', 'wide', 'large'], sidesAllowed: 0, sidesWithSeconds: -1 },
  { id: 28, label: 'Bricolage Grotesque', height: 40, preview: "font-family: 'Bricolage Grotesque', Impact, 'Arial Narrow', sans-serif; font-weight: 700;", small: false, mainClock: true,
    google: 'Bricolage Grotesque', weight: 700, sizePx: 48, categories: ['modern', 'bold', 'wide', 'large'], sidesAllowed: 0, sidesWithSeconds: -1 },
  { id: 29, label: 'Chango',              height: 40, preview: "font-family: 'Chango', 'Courier New', monospace;", small: false, mainClock: true, google: 'Chango', weight: 400, sizePx: 48, categories: ['funky', 'stylish', 'bold', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 30, label: 'EmblemaOne',          height: 40, preview: "font-family: 'Emblema One', 'Arial Narrow', sans-serif; letter-spacing: 1px;", small: false, mainClock: true, google: 'Emblema One', weight: 400, sizePx: 48, categories: ['stylish', 'narrow', 'bold', 'large'], sidesAllowed: 1, sidesWithSeconds: 0 },
  { id: 31, label: 'Fraunces',            height: 40, preview: "font-family: 'Fraunces', Georgia, serif; font-weight: 700;", small: false, mainClock: true, google: 'Fraunces', weight: 700, sizePx: 48, categories: ['serif', 'stylish', 'bold', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 32, label: 'Geostar Fill',        height: 40, preview: "font-family: 'Geostar Fill', Impact, sans-serif;", small: false, mainClock: true, google: 'Geostar Fill', weight: 400, sizePx: 48, categories: ['stylish', 'funky', 'modern', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 33, label: 'Michroma',            height: 40, preview: "font-family: 'Michroma', 'Arial Black', sans-serif; letter-spacing: 1px;", small: false, mainClock: true,
    google: 'Michroma', weight: 400, sizePx: 48, categories: ['modern', 'wide', 'large'], sidesAllowed: 0, sidesWithSeconds: -1 },
  { id: 34, label: 'National Park',       height: 40, preview: "font-family: 'National Park', Verdana, sans-serif; font-weight: 700;", small: false, mainClock: true, google: 'National Park', weight: 700, sizePx: 48, categories: ['modern', 'stylish', 'bold', 'large'], sidesAllowed: 1, sidesWithSeconds: 0 },
  { id: 35, label: 'Komika',              height: 40, preview: "font-family: 'Bangers', 'Comic Sans MS', cursive;", small: false, mainClock: true,
  ...
  { id: 36, label: 'Quantico',            height: 40, preview: "font-family: 'Quantico', Impact, 'Arial Narrow', sans-serif; font-weight: 700; font-style: italic;", small: false, mainClock: true, google: 'Quantico', weight: 700, italic: true, sizePx: 48, categories: ['modern', 'italic', 'bold', 'narrow', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 37, label: 'Silkscreen',          height: 40, preview: "font-family: 'Silkscreen', Impact, 'Arial Narrow', sans-serif;", small: false, mainClock: true, google: 'Silkscreen', weight: 400, sizePx: 48, categories: ['pixelated', 'digital', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 38, label: 'StackSansHeadline',   height: 40, preview: "font-family: 'Anton', 'Arial Narrow', sans-serif;", small: false, mainClock: true, google: 'Anton', weight: 400, sizePx: 48, approx: true, categories: ['modern', 'bold', 'narrow', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 }, // Stack Sans Headline isn't on Google Fonts (independent foundry release) -- Anton's ultra-bold condensed headline shape is the closest match.
  { id: 39, label: 'Unbounded',           height: 40, preview: "font-family: 'Unbounded', Impact, 'Arial Narrow', sans-serif; font-weight: 500;", small: false, mainClock: true, google: 'Unbounded', weight: 500, sizePx: 48, categories: ['modern', 'stylish', 'bold', 'large'], sidesAllowed: 1, sidesWithSeconds: 0 },
  { id: 40, label: 'Wallpoet',            height: 40, preview: "font-family: 'Wallpoet', Impact, 'Arial Narrow', sans-serif;", small: false, mainClock: true, google: 'Wallpoet', weight: 400, sizePx: 48, categories: ['stylish', 'funky', 'modern', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 41, label: 'ZalandoSans',         height: 40, preview: "font-family: 'Zalando Sans Expanded', Impact, 'Arial Narrow', sans-serif; font-weight: 500;", small: false, mainClock: true, google: 'Zalando Sans Expanded', weight: 500, sizePx: 48, categories: ['modern', 'wide', 'bold', 'large'], sidesAllowed: 1, sidesWithSeconds: 0 },
  ...
  { id: 45, label: 'M Plus 1C',           height: 40, preview: "font-family: 'M PLUS 1 Code', Impact, 'Arial Narrow', sans-serif; font-weight: 700;", small: false, mainClock: true, google: 'M PLUS 1 Code', weight: 700, sizePx: 48, categories: ['modern', 'bold', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  { id: 46, label: 'Reddit Sans',         height: 40, preview: "font-family: 'Reddit Sans', Impact, 'Arial Narrow', sans-serif; font-weight: 700;", small: false, mainClock: true, google: 'Reddit Sans', weight: 700, sizePx: 48, categories: ['modern', 'bold', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 },
  ...
  { id: 52, label: 'DS Digital Bold',     height: 48, preview: "font-family: 'DS-Digital', 'Courier New', monospace; font-weight: 700;", small: false, mainClock: true, cdn: 'ds-digital', sizePx: 48, categories: ['digital', 'bold', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 48
  { id: 53, label: 'DS Digital Bold Italic',height: 48, preview: "font-family: 'DS-Digital', 'Courier New', monospace; font-weight: 700; font-style: italic;", small: false, mainClock: true, cdn: 'ds-digital', sizePx: 48, categories: ['digital', 'bold', 'italic', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 48
  { id: 54, label: 'LCD',                 height: 48, preview: "font-family: 'Press Start 2P', 'Courier New', monospace;", small: false, mainClock: true, google: 'Press Start 2P', weight: 400, sizePx: 48, approx: true, categories: ['digital', 'pixelated', 'large'], sidesAllowed: 2, sidesWithSeconds: 0 }, // see id 50
  { id: 55, label: 'Rebel Redux',         height: 48, preview: "font-family: 'RebelRedux', 'Arial Narrow', 'Impact', sans-serif; font-weight: 500;", small: false, mainClock: true, cdn: 'rebelredux', sizePx: 48, categories: ['stylish', 'funky', 'modern', 'bold', 'large'], sidesAllowed: 1, sidesWithSeconds: 0 } // RebelRedux (dafont-only) is hosted on cdnfonts.com as a webfont -- see cdnFontLinks() in config-page.js.
