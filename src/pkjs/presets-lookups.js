...
var FONT_LOOKUP = [
  ...
  { id: 56, label: '00TT'       , height: 48, preview: 'font-family: \'Press Start 2P\', \'Courier New\', monospace;'                              , small: false, google: 'Press Start 2P', sizePx: 48, approx: true, categories: ['digital', 'bold', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: true , resourceName: "ZEROZERO_FONT_48", fileName: "fonts/00TT.TTF" },
  { id: 57, label: 'SciFly Sans'       , height: 54, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: false, cdn: 'scifly', sizePx: 54, approx: true, categories: ['stylish', 'modern', 'digital', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '-1' , mainClock: true , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
  { id: 58, label: 'SciFly Sans small'       , height: 21, preview: 'font-family: \'SciFly\', \'Courier New\', monospace;'                              , small: true, cdn: 'scifly', sizePx: 21, approx: true, categories: ['stylish', 'modern', 'digital', 'small']                      , mainClock: false , weight: 400 , romanOk: true, resourceName: "SCIFLYSANS_FONT_48", fileName: "fonts/SciFly-Sans.ttf" },
  { id: 59, label: 'Bitcount Grid'       , height: 48, preview: 'font-family: \'Bitcount Grid Double\', \'Courier New\', monospace;'                              , small: false, google: 'Bitcount Grid Double', sizePx: 48, approx: true, categories: ['digital', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 300 , romanOk: true, resourceName: "BITCOUNTGRID_FONT_48", fileName: "fonts/BitcountGridDouble-Light.ttf" },
  { id: 60, label: 'ZCOOL KuaiLe'       , height: 48, preview: 'font-family: \'ZCOOL KuaiLe\', \'Courier New\', monospace;'                              , small: false, google: 'ZCOOL KuaiLe', sizePx: 48, approx: true, categories: ['funky', 'handwritten', 'bold', 'large']                      , sidesAllowed: 2   , sidesWithSeconds: '0' , mainClock: true , weight: 400 , romanOk: true, resourceName: "RESOURCE_ID_ZCOOL_FONT_48", fileName: "fonts/ZCOOLKuaiLe-Regular.ttf" },  // Big Digital styles (ids 100-109) -- NOT a text font at all, unlike
